...
@Component({
  selector: 'app-flightswithoutuid',
  templateUrl: './flightswithoutuid.component.html',
  styleUrls: ['./flightswithoutuid.component.css']
})
export class FlightswithoutuidComponent implements OnInit {
