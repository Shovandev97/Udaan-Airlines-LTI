...
@Component({
  selector: 'app-homewithoutuid',
  templateUrl: './homewithoutuid.component.html',
  styleUrls: ['./homewithoutuid.component.css']
})
export class HomewithoutuidComponent implements OnInit {
  ...
  formSubmit(){
    ...
    this.route.navigate(['/flights/'+this.bookingdetails.from+'/'+this.bookingdetails.to+'/'+newdate+'/'+this.bookingdetails.class+'/'+this.bookingdetails.adult])
  }
